...
function Navbar() {
  ...
  return (
    <>
      <div className="navbar-container position-relative bg-[#030407] flex justify-center gap-4 m-4 min-h-[100px] w-full px-[100px]">
        <div
        ...
        >
          ...
          "
            >
              ...
              <NavLink to="/Projects">
                <li className="hover:text-[#66FCF1]">Projects</li>
              </NavLink>
              <NavLink to="/Blog">
                <li className="hover:text-[#66FCF1]">Blog</li>
              </NavLink>
              <NavLink to="/Technical Support">
                <li className="hover:text-[#66FCF1]">Technical Support</li>
              </NavLink>
              <NavLink to="/About">
                <li className="hover:text-[#66FCF1]">About</li>
              </NavLink>
            </ul>
          </div>
          <a
