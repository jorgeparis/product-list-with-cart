...
products_cart.innerHTML = `
      <div class="emppty-cart">
          <h1 style="color: rgb(145, 69, 69); align-self: flex-start;">Your Cart <span class="cart-product-counter">(0)<span></h1>
         ...
         <h5 style="color: rgb(80, 83, 82);">You added products will appear here</h5>
        </div>
        <div class="cart-with-productos">
          <h1 style="color: rgb(145, 69, 69); align-self: flex-start;">Your Cart <span class="cart-product-counter">(7)<span></h1>
            <div class="items-selected">
  
              <div class="items">
                <h5>Classic Tiramissu</h5>
                <div class="items-number">         
                  <a href="" class="number-of-items" style="color: brown; font-weight: bold;">1X</a>
                  <a href="" class="number-of-items">@5.5</a>.<a href="" class="number-of-items">@5.5</a>
                </div>
...
document.addEventListener("click", (event) => {
  if (
    event.target.matches(".cart-container") ||
